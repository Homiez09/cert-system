        ...
        <>
            <div className="flex flex-col items-center w-full">
                <div className="flex flex-col px-3 gap-5">
                    ...
                    <div id="mobileNav" className={`z-[999] ${isFixed ? 'fixed top-0 left-0 right-0 shadow-md bg-white py-5 animate-navbarDown' : 'animate-navbarUp'} lg:hidden`}>
                        <div className="flex flex-row justify-between items-center px-2 w-full">
                            {isDropdownOpen ? (
                                <MingcuteCloseFill className="w-7 h-auto" onClick={toggleDropdown} />
                            ) : (
                        ...
                        {isDropdownOpen && (
                            <div className="p-5 animate-navbarMobileMenu">
